...
详情见[AuthenticationManager](/SpringSecurity/API/AuthenticationManager)

## 3.DaoAuthenticationProvider

> 调用UserDetailsService查询用户信息

详情见[AuthenticationProvider](/SpringSecurity/API/AuthenticationProvider)

## 4.认证结果处理

> 根据上一组件中获取的用户信息进行密码匹配
